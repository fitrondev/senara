    ...
    <section className="min-h-[calc(100vh-4rem)] relative overflow-hidden py-12 md:py-16 lg:py-0 flex items-center justify-center">
      <div className="container">
        <div className="grid items-center justify-center gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-16">
          <div className="max-w-2xl flex flex-col gap-5 text-center lg:text-left">
            ...
            <p className="mx-auto max-w-2xl text-sm leading-7 text-muted-foreground sm:text-lg lg:mx-0">
            ...
            <div className="flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center lg:justify-start">
              <Show when={"signed-out"}>
                <Button size={"lg"} asChild className="w-full sm:w-auto">
                  <SignInButton mode="modal">Mulai Sekarang</SignInButton>
                </Button>
              </Show>
